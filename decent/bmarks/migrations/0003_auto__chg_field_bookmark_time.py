...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bookmark.time'
        db.alter_column('bmarks_bookmark', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Bookmark.time'
        db.alter_column('bmarks_bookmark', 'time', self.gf('django.db.models.fields.DateTimeField')())
